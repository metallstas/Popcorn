...
void AActive_Brick::Setup_Colors()
{
   ...
   for (i = 0; i < Max_Fade_Step; i++) {
      ...
      AActive_Brick::Get_Fading_Color(AsConfig::Brick_Red_Color, i, Fading_Red_Brick_Pens[i], Fading_Red_Brick_Brushes[i]);

      AActive_Brick::Get_Fading_Color(AsConfig::Brick_Blue_Color, i, Fading_Blue_Brick_Pens[i], Fading_Blue_Brick_Brushes[i]);
